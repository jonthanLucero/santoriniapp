...
import com.example.santoriniapp.utils.urbanizationAddPhotoGallery.JadblackPhotoViewer;
...
public class JadBlackCameraField extends LinearLayout {
	...
	public void generateOutputFileName(){
		//PREPARE FILE NAME
		fileName = StringFunctions.toString(
				NumericFunctions.toLong(
				DateFunctions.now()
			)
		) + ".jpg";
                ...
                try {
                    ...
                    if (photoFile != null) {
                        ...
                        Uri photoURI = FileProvider.getUriForFile(mContext,
                                "com.example.santoriniapp.fileprovider", // Cant be renamed. Check the provider in Manifest.xml of the NativeCode.
                                photoFile);
