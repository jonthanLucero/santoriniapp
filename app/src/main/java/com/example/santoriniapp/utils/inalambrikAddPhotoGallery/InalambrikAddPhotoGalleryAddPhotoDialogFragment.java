...
public class InalambrikAddPhotoGalleryAddPhotoDialogFragment extends DialogFragment {
    ...
    public InalambrikAddPhotoGalleryAddPhotoDialogFragment() {
    ...
    //  Instance Helper
    // ------------------------------------------------------------------------------
    public static InalambrikAddPhotoGalleryAddPhotoDialogFragment newInstance() {
        InalambrikAddPhotoGalleryAddPhotoDialogFragment fragment = new InalambrikAddPhotoGalleryAddPhotoDialogFragment();
        return fragment;
    }
    ...
    public interface AddPhotoListener{
        void addImage(InalambrikAddPhotoGalleryItem image);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addPhotoActionButton.setOnClickListener(new ImageButton.OnClickListener(){
            public void onClick(View view){
                ...
                InalambrikAddPhotoGalleryItem image = new InalambrikAddPhotoGalleryItem(editTexttitulo.getText().toString(),
