...
public class UrbanizationAddPhotoGalleryItem
{
    ...
    public UrbanizationAddPhotoGalleryItem(String photoTitle, String photoDescription, String photoPath, boolean isDisplayMode) {
