...
public class InalambrikAddPhotoGalleryAdapter extends RecyclerView.Adapter<InalambrikAddPhotoGalleryAdapter.GalleryViewHolder>  {

    private final LayoutInflater layoutInflater;
    private Context mContext;
    private List<InalambrikAddPhotoGalleryItem> mImagenList;
    ...
    //  Constructor
    // -------------------------------------------------------------------------------
    public InalambrikAddPhotoGalleryAdapter(Context context) {
    ...
    public GalleryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = layoutInflater.inflate(R.layout.list_item_inalambrik_add_photo_gallery, parent, false);
    ...
    public void onBindViewHolder(@NonNull GalleryViewHolder holder, int position) {
        if (mImagenList != null) {
            InalambrikAddPhotoGalleryItem item = mImagenList.get(position);
    ...
    //  Setter/Getter items
    // -------------------------------------------------------------------------------
    public void setImageList(List<InalambrikAddPhotoGalleryItem> mImagenList) {
        this.mImagenList=mImagenList;
        notifyDataSetChanged();
    }

    public List<InalambrikAddPhotoGalleryItem> getImageList() {
        return mImagenList;
    }
    ...
    public class GalleryViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(InalambrikAddPhotoGalleryItem imagen, int position) {
