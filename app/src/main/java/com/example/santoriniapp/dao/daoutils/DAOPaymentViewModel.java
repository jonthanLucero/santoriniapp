...
public class DAOPaymentViewModel extends AndroidViewModel {
    ...
    public List<Payment> getPaymentsByMonth(String month,String userId)
    {
        return mRepository.getAllPaymentByMonth(month,userId);
    }
    ...
    public void insertDummyPayments()
    {
        ...
        mRepository.insertPaymentToDB(new Payment("1",dateTime,2021,"1","1",1,1,100,"A","Comentario 1","",dateNow));
        ...
        dateTime = date.getTime();
        mRepository.insertPaymentToDB(new Payment("1",dateTime,2021,"1","1",2,2,200,"P","Comentario 2","",dateNow));

        date = DateConverter.StringToDateTime("16-02-2021 10:20:20");
        dateTime = date.getTime();
        mRepository.insertPaymentToDB(new Payment("1",dateTime,2021,"1","1",3,3,300,"P","Comentario 3","",dateNow));

        //Marzo
        date = DateConverter.StringToDateTime("03-03-2021 10:20:20");
        dateTime = date.getTime();
        mRepository.insertPaymentToDB(new Payment("1",dateTime,2021,"1","1",3,3,300,"X","Comentario 3","",dateNow));
