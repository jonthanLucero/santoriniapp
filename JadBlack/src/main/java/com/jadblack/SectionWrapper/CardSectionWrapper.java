 ...
 */
public class CardSectionWrapper extends CardView {

    /**
     * Constructors
     */
    public CardSectionWrapper(Context context) {
        super(context);
    }

    public CardSectionWrapper(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CardSectionWrapper(Context context, AttributeSet attrs, int defStyleAttr) {
