 ...
 */
public class ScrollableSectionWrapper extends ScrollView {

    /**
     * Constructors
     */
    public ScrollableSectionWrapper(Context context) {
        super(context);
    }

    public ScrollableSectionWrapper(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ScrollableSectionWrapper(Context context, AttributeSet attrs, int defStyleAttr) {
