...
public class ScaleImageView extends ImageView implements OnTouchListener {
	...
	public final static String tag = ScaleImageView.class.getName();
    ...
    protected boolean setFrame(int l, int t, int r, int b) {      	
        ...
        if (mScale * mIntrinsicHeight > mHeight) {
        	Log.d(tag, "Vertical scale required");
        	...
        	Log.d(tag, "Horizontal scale required");
    ...
    public void zoomTo(float scale, int x, int y) {
    	//Log.d(tag, "Current:" + getScale() + ", Min:" + mMinScale + ", Req:" + scale + " > " + (getScale()*scale) + " (" + x + "," + y + ")");
    ...
    private float dispDistance() {
        return (float) java.lang.Math.sqrt(mWidth * mWidth + mHeight * mHeight);
    }
